    ...
    <section className="pt-20 md:pt-32 pb-16 md:pb-20 px-4 md:px-6 bg-gradient-to-b from-background via-background to-card/30">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          {/* Left Content */}
          <div
            className={`space-y-4 md:space-y-6 ${isLoaded ? 'animate-fade-in-up' : 'opacity-0'}`}
          >
            <div className="space-y-2">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight">
                Hi, I'm <span className="text-accent">Divine Anyanechi</span>
              </h1>
            </div>

            <p className="text-base md:text-lg text-foreground/70 leading-relaxed max-w-lg">
              A Software Developer and Creative Technologist building
              intelligent, scalable, and human-centered systems that power
              innovation across fintech, AI, and social impact.
            </p>
