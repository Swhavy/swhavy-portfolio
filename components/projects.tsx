...
const projects = [
  {
    ...
    image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-XSgxUpUchBovV7YPgnGMmO26CoLYz4.png",
  ...
  },
  {
    ...
    image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-kqJC1jjYHkAMrY2ZI7j8Y1p0sDREIx.png",
    tech: ["Next.js", "Node.js", "OpenAI API", "Firebase", "TailwindCSS"],
  ...
  },
  {
    ...
    image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-Cs0swOTRqUO9cJ1H7UaiJpSS2hEJ37.png",
  ...
  },
  {
    ...
    image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-B4Pj4g8YqsnaKxUC4z3cVhQfZtTWGY.png",
  ...
  },
  {
    ...
    image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-rPR75flyMYmA5e5Z7LTYKTduBTFDCS.png",
...
export function Projects() {
  ...
  return (
    <section id="projects" className="py-16 md:py-20 px-4 md:px-6 bg-card/30" ref={ref}>
          ...
          {projects.map((project, index) => (
            ...
            >
              <div className="grid md:grid-cols-2 gap-6 md:gap-8 items-center">
                ...
                <div
                  className={`relative h-48 sm:h-64 md:h-80 rounded-xl overflow-hidden border border-accent/20 ${index % 2 === 1 ? "md:order-2" : ""}`}
                >
                  <Image
                    ...
                    placeholder="blur"
                    blurDataURL={
                      blurPlaceholders[project.title.toLowerCase().replace(/\s+/g, "")] || blurPlaceholders.arcflow
                    }
                  />
                  {project.inProgress && (
                    <div className="absolute inset-0 bg-background/40 flex items-center justify-center">
                      <span className="text-accent font-semibold text-sm md:text-base">In Progress</span>
                    </div>
                  )}
                </div>
                ...
                <div className={`space-y-4 ${index % 2 === 1 ? "md:order-1" : ""}`}>
                  ...
                  <p className="text-foreground/70 leading-relaxed text-sm md:text-base">{project.description}</p>

                  <div className="space-y-3">
                    <div>
                      <p className="text-xs md:text-sm text-foreground/50 mb-2">Tech Stack</p>
                      <div className="flex flex-wrap gap-2">
                        {project.tech.map((tech) => (
                          <span key={tech} className="px-2 md:px-3 py-1 bg-accent/10 text-accent text-xs rounded-full">
                            {tech}
                          </span>
                        ))}
                      </div>
                    ...
                    <div className="pt-2 border-t border-border">
                      <p className="text-xs md:text-sm text-accent font-semibold">Impact: {project.impact}</p>
                    </div>
                  </div>
